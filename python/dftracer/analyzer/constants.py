...
HUMANIZED_LAYERS = dict(
    ...
    # cat + POSIX_CAT_RULES suffixes
    posix_lustre='POSIX - All (Lustre)',
    posix_gpfs='POSIX - All (GPFS)',
    posix_ssd='POSIX - All (SSD)',
    posix_reader_lustre='POSIX - Reader (Lustre)',
    posix_reader_gpfs='POSIX - Reader (GPFS)',
    posix_reader_ssd='POSIX - Reader (SSD)',
    posix_checkpoint_lustre='POSIX - Checkpoint (Lustre)',
    posix_checkpoint_gpfs='POSIX - Checkpoint (GPFS)',
    posix_checkpoint_ssd='POSIX - Checkpoint (SSD)',
    # dftracer interceptor categories
    stdio='STDIO - All',
    mpi='MPI',
    mpiio='MPI-IO',
    c_app='C App',
    cpp_app='C++ App',
    # pydftracer categories
    ai='AI',
    ai_root='AI Root',
    compute='Compute',
    data='Data',
    ...
    data_loader='DLIO Data Loader',
    data_loader_fork='DLIO Data Loader Fork',
    reader='Reader',
